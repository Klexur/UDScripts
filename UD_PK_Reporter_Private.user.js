...
// @namespace      Klexur
// @version        0.2.3
// @description    Automates the task of submitting a Dumbwit url to the Rogues Gallery (Hides HP, AP, and Inventory).
...
function makePrivate() {
	...
	points.snapshotItem(0).innerHTML = 'XX'; // HP
	points.snapshotItem(2).innerHTML = 'XX'; // AP
	...
	for (var i=0; i<forms.snapshotLength; i++) {
		forms.snapshotItem(i).parentNode.removeChild(forms.snapshotItem(i));
	}
}
